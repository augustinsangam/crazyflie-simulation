...
#include "sgba/median_filter.hpp"
#include "sgba/sgba.hpp"
#include "sgba/wallfollowing_multiranger_onboard.hpp"
#include "sgba/wallfollowing_with_avoid.hpp"
...
void appMain(void *param) {
	...
	p2pRegisterCB(p2pcallbackHandler);               // TODO
	uint64_t address = configblockGetRadioAddress(); // TODO
	...
	systemWaitStart();
	vTaskDelay(M2T(3000)); // TODO : Change later
	while (1) {
		// some delay before the whole thing starts
		vTaskDelay(
		    10); // TODO : Will be replaced by argos ticks and control step
		...
		point_t pos;
		estimatorKalmanGetEstimatedPos(&pos); // TODO : Position of the drone
